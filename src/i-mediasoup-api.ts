...
export interface IMediasoupApiClient {
    ...
    on(event: EVENT.MIXER_FILE_STARTED, listener: (json:MixerStreamData) => void): this
    on(event: EVENT.MIXER_FILE_STOPPED, listener: (json:MixerStreamData) => void): this
}
export interface IMediasoupApi extends Record<ACTION, (json:{})=>Promise<{}|void>>{
    ...
    [ACTION.TCP_STREAMING](json:TcpStreamingRequest):Promise<StreamingPortsData>
    ...
    [ACTION.MIXER_PIPE_START](json:MixerPipeLiveData|MixerPipeRecordingData|MixerPipeRtmpData|MixerPipeHlsData|MixerPipePortData):Promise<MixerPipeInput>
    [ACTION.MIXER_PIPE_STOP](json:MixerPipeStopInput):Promise<void>
    [ACTION.MIXER_COMMAND](json:MixerCommandInput):Promise<void>
    [ACTION.LISTEN_MIXER_STOPPED](json:MixerInput):Promise<boolean>
    [ACTION.LISTEN_MIXER_FILE_STARTED](json:MixerStreamData):Promise<boolean>
    [ACTION.LISTEN_MIXER_FILE_STOPPED](json:MixerStreamData):Promise<boolean>
    [ACTION.CLEAR_PIPE_TRANSPORTS](json:ClearPipeTransportsInput):Promise<void>
    [ACTION.HEAP_SNAPSHOT]():Promise<void>
