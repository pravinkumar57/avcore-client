...
export declare class MediasoupSocketApi implements IMediasoupApi {
    ...
    allocatePort(): Promise<PortData>;
    releasePort(json: PortData): Promise<void>;
